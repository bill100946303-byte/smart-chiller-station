<template>
  ...
  >
    ...
    <div v-if="runlist2.length" class="temp-section">
      <div class="title">
...
export default {
  ...
  computed: {
    ...mapGetters(["runlist2", "websocket", "template", "HotStationTotalPower", "userid"]),
    powerStats() {
      return Object.keys(this.HotStationTotalPower || {}).map((key) => {
        ...
        return {
          key,
          label: key,
          value: this.formatPowerValue(this.HotStationTotalPower[key]),
...
.left-contatiner {
  ...
  .hot-left {
    ...
    .chart {
      ...
      border-radius: 20px;
      background:
          radial-gradient(circle at top right, rgba(255, 208, 112, 0.12), transparent 40%),
