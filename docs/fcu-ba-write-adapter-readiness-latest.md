...
| 全局执行闸门 | 未通过 | P0 | dispatchAllowed=false, blocked=site_authorization_window_active/backend_not_readonly | -- |
| 白名单包含首台 Canary | 通过 | P0 | WSJ01 in whitelist=true | -- |
| Canary 写点映射完整 | 通过 | P0 | point=设置温度, tag=WSJ01-508-40357, value=25.5 | -- |
| Canary 当前快照质量 | 通过 | P0 | temp=27, commAlarm=false | -- |
...
- 只有本报告 ok=true 后，才允许进入 WSJ01 单台真实写入窗口。
